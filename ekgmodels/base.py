...
from ekgmodels.misc import roc_auc_score_nan, r2_score_nan, f1_score_nan
import pandas as pd
...
class NanBCEWithLogitsLoss(nn.Module):
    ...
    def __init__(self, size_average=True):
        ...
        self.bce_loss = nn.BCEWithLogitsLoss(size_average=size_average)
...
class NanMSELoss(nn.Module):
    ...
    def __init__(self, size_average=True):
        ...
        self.mse_loss = nn.MSELoss(size_average=size_average)
...
def run_epoch(epoch, model, data_loader, optimizer, do_cuda,
    ...
    if model.is_continuous:
        ...
        print(" r2 score: ", r2_score_nan(trues, preds))
        target_f1 = "n/a"
    else:
